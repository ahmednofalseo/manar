...
function showToast(type, message) {
    ...
    toast.className = `fixed top-20 left-4 right-4 sm:right-auto sm:left-4 z-[70] p-4 rounded-lg shadow-lg max-w-md text-white animate-slide-in mx-auto sm:mx-0 ${
