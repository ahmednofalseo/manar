...
@section('title', 'إضافة مرحلة جديدة - ' . \App\Helpers\SettingsHelper::systemName())
@section('page-title', 'إضافة مرحلة جديدة')
...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl md:text-3xl font-bold text-white">إضافة مرحلة جديدة</h1>
...
<!-- Form -->
    <form method="POST" action="{{ route('settings.project-stages.store') }}" class="glass-card rounded-xl md:rounded-2xl p-4 md:p-6">
    @csrf
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <textarea 
                ...
                rows="3"
                class="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-400/40"
                placeholder="وصف مختصر عن المرحلة"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                >
                <p class="text-gray-400 text-xs mt-1">استخدم أيقونات Font Awesome (مثال: fas fa-building)</p>
            </div>
            ...
            <div>
                ...
                >
                <p class="text-gray-400 text-xs mt-1">استخدم كود اللون Hex (مثال: #1db8f8)</p>
            </div>
        </div>
