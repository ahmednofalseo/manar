...
@section('title', 'تعديل المدينة - ' . \App\Helpers\SettingsHelper::systemName())
@section('page-title', 'تعديل المدينة')
...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl md:text-3xl font-bold text-white">تعديل المدينة</h1>
...
<!-- Form -->
    <form method="POST" action="{{ route('settings.cities.update', $city) }}" class="glass-card rounded-xl md:rounded-2xl p-4 md:p-6">
    @csrf
    @method('PUT')
